...
#SRC = firefly_solver.c					# by Xun
#SRC += solver.c					# by Xun
#SRC += ldl.c						# by Xun
#SRC += matrix_support.c			# by Xun
#SRC += util.c					# by Xun
...
#SRCARM += elevAileMpcMatrices.c	# by Xun
#SRCARM += aileronMpc.c 					# by Xun
#SRCARM += miscellaneous.c 					# by Xun
#SRCARM += mpc.c 					# by Xun

#SRCARM += firefly_height_PD_control.c	# by Xun
#SRCARM += CmatrixLib.c 					# by Xun
#SRCARM += firefly_KF_disturbance_observer.c 					# by Xun

#SRCARM += mpc_const.c					# by Xun
#SRCARM += mtx_ops.c					# by Xun
#SRCARM += fip_ops.c					# by Xun
#SRCARM += mpc_ref.c					# by Xun
#SRCARM += mpc_inc.c					# by Xun
#SRCARM += mpc_stc.c					# by Xun
#SRCARM += mpc.c					# by Xun
#SRCARM += firefly_mpc.c					# by Xun

#SRCARM += solver.c					# by Xun
#SRCARM += firefly_solver.c					# by Xun
#SRCARM += ldl.c						# by Xun
#SRCARM += matrix_support.c			# by Xun
#SRCARM += util.c					# by Xun
