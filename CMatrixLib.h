 ...
 * @param b vector
 */
void vector_float_add(vector_float * m, const vector_float * b);
 ...
 * @param b vector
 */
void vector_float_subtract(vector_float * m, const vector_float * b);
 ...
 * @param b vector
 */
float vector_float_inner_product(const vector_float * m, const vector_float * b);
 ...
 */
void vector_float_outer_product(const vector_float * m, const vector_float * b, matrix_float * C);
 ...
 */
void vector_float_times(vector_float * m, const float C);
 ...
 */
void vector_float_copy(vector_float * m, const vector_float * b);
 ...
 */
void matrix_float_transpose(const matrix_float * m, matrix_float * C);
 ...
 */
void matrix_float_copy(matrix_float * m, const matrix_float * b);
 ...
 */
void matrix_float_add(matrix_float * m, const matrix_float *b);
 ...
 * @param b second matrix
 */
void matrix_float_sub(matrix_float * m, const matrix_float *b);
 ...
 */
void matrix_float_mul(const matrix_float * m, const matrix_float * b, matrix_float * C);
 ...
 * @param C output matrix
 */
void matrix_float_mul_trans(const matrix_float * m, const matrix_float * b, matrix_float * C);
 ...
 */
void matrix_float_times(matrix_float * m, const float C);
 ...
 * @param a matrix
 */
float matrix_float_determinant(const matrix_float * m);
 ...
 * @param a matrix
 */
int matrix_float_inverse(matrix_float * m);
